...
public class Frag_GameMap9 extends BaseFragment {
        ...
        if (requestCode == 0){//扫描返回，弹出惊喜、随机贴纸
            ...
            MyApplication.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (n>=9){
                        Result2Popwindow result2Popwindow = new Result2Popwindow(getActivity());
                        result2Popwindow.showPopupWindow(iv_scan);
                    }else{
                        if (popwindow==null){
    ...
    public void initUI() {
        ...
        iv_goright.setVisibility(View.INVISIBLE);
