...
/**
 * Created by sahara on 2016/11/14.
 */
...
//        this.setEnableLog(true);
         ...
         */
//        this.initPreLoader(this.getApplicationContext(), "7e032cb43267d849-00-qds6q1");
        ...
        // 开发ID (请前往 http://tusdk.com 获取您的APP 开发秘钥)
         TuSdk.init(this.getApplicationContext(), "7e032cb43267d849-00-qds6q1");
