...
import com.herbalife.myapplication.camera.adapter.FilterAdapter;
import com.herbalife.myapplication.camera.adapter.StickerToolAdapter;
import com.herbalife.myapplication.camera.customview.LabelView;
import com.herbalife.myapplication.camera.customview.MyHighlightView;
import com.herbalife.myapplication.camera.customview.MyImageViewDrawableOverlay;
import com.herbalife.myapplication.camera.model.Addon;
import com.herbalife.myapplication.camera.model.TagItem;
import com.herbalife.myapplication.camera.util.EffectService;
import com.herbalife.myapplication.camera.util.EffectUtil;
import com.herbalife.myapplication.camera.util.FileUtils;
import com.herbalife.myapplication.camera.util.FilterEffect;
import com.herbalife.myapplication.camera.util.GPUImageFilterTools;
import com.herbalife.myapplication.camera.util.ImageUtils;
import com.herbalife.myapplication.camera.util.StringUtils;
import com.herbalife.myapplication.camera.util.TimeUtils;
...
//        auto_menu.setVisibility(View.GONE);
        ...
        int height = App.getApp().getScreenHeight()-App.getApp().dp2px(240);
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(App.getApp().getScreenWidth(),height);
        mImageView.setLayoutParams(params);
        overlay.setLayoutParams(params);
        drawArea.addView(overlay);
        //添加标签选择器
        RelativeLayout.LayoutParams rparams = new RelativeLayout.LayoutParams(App.getApp().getScreenWidth(), height);
...
//        emptyLabelView.setVisibility(View.INVISIBLE);
        ...
        lin_tiezhi.setSelected(true);
    }

    private void initEvent() {
        lin_tiezhi.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        lin_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                commonLabelArea.setVisibility(View.GONE);
                initFilterToolBar();
                lin_tiezhi.setSelected(false);
                lin_filter.setSelected(true);
            }
        });
        ...
        lin_finish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                savePicture();
            }
    ...
    private class SavePicToFileTask extends AsyncTask<Bitmap,Void,String>{
        ...
        protected void onPostExecute(String fileName) {
            ...
            Toast.makeText(PhotoProcessActivity.this,"照片已保存至系统图库或相册！",Toast.LENGTH_LONG).show();
...
//            }, "取消", null);
    ...
    private void initStickerToolBar(){
        ...
        ArrayList<Addon> list = UtilObjectIO.readObject(ArrayList.class,MyApplication.mDownLoadPath,"tiezhi");
        final ArrayList<Addon> copyList = new ArrayList<>();
        ...
        bottomToolBar.setAdapter(new StickerToolAdapter(PhotoProcessActivity.this, copyList));
...
//                labelSelector.hide();
                Addon sticker = copyList.get(arg2);
                if (!sticker.isLight){
//                    showToast("未解锁，快去发现之旅吧！");
                    showDialog();
                    return;
                }
...
//        setCurrentBtn(stickerBtn);
    ...
    private AlertDialog showDialog(){
        ...
        final AlertDialog alertDialog = builder.setTitle("温馨提示：")
                .setMessage("您的贴纸还没有解锁哦，快去扫描更多二维码吧！")
