...
//        ImageSelectObservable.getInstance().clearSelectImgs();
        ImageSelectObservable.getInstance().deleteObservers();
        super.onDestroy();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_photo_ok:
                ...
                Intent intent = new Intent(this, Act_PicTOVideo.class);//跳转到合成视屏界面
                intent.putExtra("piclist", (Serializable) mAdapter.getSelectlist());
