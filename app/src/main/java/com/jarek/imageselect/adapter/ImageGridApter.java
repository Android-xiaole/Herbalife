...
import java.util.List;
 ...
 public class ImageGridApter extends BaseRecyclerAdapter<ImageFolderBean, RecyclerView.ViewHolder> {
     ...
     public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
         ...
         imageBean.position = viewHolder.getPosition();

         notifyImageChanged(viewHolder.picIv, imageBean);
         nitifyCheckChanged(viewHolder, imageBean);

         /*点击监听*/
         setSelectOnClickListener(viewHolder.selectView, imageBean, viewHolder.getPosition());
         setOnItemClickListener(viewHolder.mCardView, viewHolder.getPosition());
